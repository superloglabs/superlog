  ...
  input_schema: {
    ...
    properties: {
      ...
      validationPassed: {
        type: "boolean",
        description:
          "True only when the strongest validation rung you could actually execute passed. An honest false is acceptable — the PR still opens, flagged for careful review; fabricated validation is not.",
      },
      validationSummary: {
        type: "string",
        description:
