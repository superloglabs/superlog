...
const SERVICE_NAME = "@superlog/api";
...
// Bridges each pino log line to the global OTel LoggerProvider set up in
// tracing.ts. We do this via pino.multistream rather than the auto-instrumentation
// because the latter relies on import-in-the-middle, which broke other ESM
// modules' named exports (drizzle-orm, etc.) when registered globally.
